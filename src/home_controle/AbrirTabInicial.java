...
public class AbrirTabInicial {
    ...
    private void paginaInicial(){
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            BrowserFX = new BrowserFX( getClass().getResource("/fonema_e_letra/Fonema_e_Letra_Home.html").toString() );
  
            JPanel p = new JPanel( new BorderLayout() );
            p.add( BrowserFX, BorderLayout.CENTER );
            
            Home.ControleTabs.AddTabHome( "Home", "/fonema_e_letra_imagens/casahome.gif", p );
