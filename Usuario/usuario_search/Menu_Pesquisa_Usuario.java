...
import usuario_visualizar.Usuario_Visualizar;
import derby.DB;
...
public class Menu_Pesquisa_Usuario extends javax.swing.JPanel {
    ...
    public void tabela(Tabela_Pesquisa_BD_Usuario Tabela_Pesquisa_BD_Usuario2){ 
                
        try {                
            Tabela_Pesquisa_BD_Usuario = Tabela_Pesquisa_BD_Usuario2;                                    
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.USUARIO WHERE LOGIN LIKE ?", usuario.Usuario.class );
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    String excluir = "DELETE FROM SCHEMAJMARY.USUARIO WHERE ID = ?";
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btAlterar.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    Usuario_Atualizar Usuario_Atualizar = new Usuario_Atualizar(Usuario_Home, Usuario, "Alterar");
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btVisualizar.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    Usuario_Visualizar Usuario_Visualizar = new Usuario_Visualizar(Usuario_Home, Usuario);
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
                            + "\nNenhuma matéria selecionada"
    ...
    public void botoesEstado2(){ 
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
                    
            if( Usuario_Permissoes.booAlterarusuario( Usuario_Logado.ID ) == true ) { btAlterar   .setEnabled(true);  }
            //System.out.println( "* "+Usuario_Logado.ID+ " - "+Usuario_Permissoes.booAlterarusuario( Usuario_Logado.ID ) );
            if( Usuario_Permissoes.booExcluirusuario( Usuario_Logado.ID ) == true ) { btExcluir   .setEnabled(true); }
