 ...
 * @author pc
 */
public class Produto_Por_Fornecedor_Home extends javax.swing.JPanel {

    public Home                                   Home;
    public JTabbedPane                            tabHome;
    
    public Produto_Por_Fornecedor_Home_Inicio       Inicio;
        
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Produto_Por_Fornecedor_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                
        Inicio = new Produto_Por_Fornecedor_Home_Inicio( this );
