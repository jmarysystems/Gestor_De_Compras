 ...
 * @author Ana
 */
public class Tabela_Pesquisa_BD_Produto_Venda_SysPdv extends Thread { 
    
    int i = 0;
    String codigoProduto = "";
    Tabela_Pesquisa_BD_Produto Tabela_Pesquisa_BD_Produto;
    
    public Tabela_Pesquisa_BD_Produto_Venda_SysPdv( Tabela_Pesquisa_BD_Produto Tabela_Pesquisa_BD_Produto2, int i2, String codigoProduto2 ){   
    ...
    public void verificarsedbexiste(){  
        synchronized(this) {  
            ...
            Tabela_Pesquisa_BD_Produto.tmPesquisa.setValueAt( vendaEmXDias( codigoProduto, 7  ) , i, 7);
            Tabela_Pesquisa_BD_Produto.tmPesquisa.setValueAt( vendaEmXDias( codigoProduto, 30 ) , i, 8);
        }  
    } 
