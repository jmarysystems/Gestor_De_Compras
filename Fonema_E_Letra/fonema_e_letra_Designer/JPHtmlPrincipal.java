...
import fonema_e_letra_tree.Fonema_e_Letra_CriarNodes_ParaTree1;
import fonema_e_letra_tree.Fonema_e_Letra_CriarNodes_ParaTree2;
...
public class JPHtmlPrincipal extends javax.swing.JPanel {
    ...
    Fonema_e_Letra_CriarNodes_ParaTree2 Fonema_e_LetraTree2;
        
    /**
     * Creates new form JPHtmlPrincipal
     */
    public JPHtmlPrincipal( Home HomeR ) {
        initComponents();
    ...
    private void inicio(){
        try{
            ...
            Fonema_e_Letra_CriarNodes_ParaTree1 Fonema_e_LetraTree1 = new Fonema_e_Letra_CriarNodes_ParaTree1( this );   
            Fonema_e_LetraTree2 = new Fonema_e_Letra_CriarNodes_ParaTree2( this );
    ...
    private void tree1ValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_tree1ValueChanged
        ...
        try {
            ...
            Fonema_e_LetraTree2.criarListaDeNodesTree2( BookInfo.bookName );
    ...
    public void livro( DefaultMutableTreeNode livroParaAdd, String nomeDeExibição, String endereçofile, String exeEnd, boolean exe, boolean des, boolean exp, boolean pro, boolean simul, String root, String pastaNoExpande, String pastaExpande, String nod, String nodTree1 ) {
        try{ 
            book = new DefaultMutableTreeNode(new BookInfo ( nomeDeExibição, endereçofile, root, pastaNoExpande, pastaExpande, nod, nodTree1 ));
        } catch( Exception e ) { 
