 ...
 * @author pc
 */
public class Categoria_do_Produto_Home extends javax.swing.JPanel {

    public Home                                   Home;
    public JTabbedPane                            tabHome;
    
    public Categoria_do_Produto_Home_Inicio       Inicio;
            
    /**
     * Creates new form Fonema_E_Letra_Home
     * @param Home2
     */
    public Categoria_do_Produto_Home( Home Home2 ) {
        initComponents();
        
        Home                       = Home2;
        tabHome                    = new JTabbedPane();
                                        
        Inicio = new Categoria_do_Produto_Home_Inicio( this );
