 ...
 */
package categoria_do_produto_search;
 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Categoria_do_Produto extends javax.swing.JPanel {

    Categoria_do_Produto_Home Categoria_do_Produto_Home;
    public  int   IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Categoria_do_Produto Tabela_Pesquisa_BD_Categoria_do_Produto;
     
    /**
     * Creates new form Cliente
     * @param Fornecedor_Home2
     */
    public Menu_Pesquisa_Categoria_do_Produto( Categoria_do_Produto_Home Categoria_do_Produto_Home2 ) {
        initComponents();
        
        Categoria_do_Produto_Home = Categoria_do_Produto_Home2;
    }
    
    public void tabela(Tabela_Pesquisa_BD_Categoria_do_Produto Tabela_Pesquisa_BD_Categoria_do_Produto2){ 
                
        try {                
            Tabela_Pesquisa_BD_Categoria_do_Produto = Tabela_Pesquisa_BD_Categoria_do_Produto2;                                    
    ...
    private void initComponents() {
        ...
        rbNome.setText("Nome da Categoria do Produto");
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.CATEGORIADOPRODUTO WHERE NOMEDACATEGORIADOPRODUTO LIKE ?", categoria_do_produto.Categoriadoproduto.class );
            q.setParameter(1, "%"+tf.toUpperCase()+"%");
            
            if(q != null) { Tabela_Pesquisa_BD_Categoria_do_Produto.pesquisa(q); }
    ...
    private void excluir() {  
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) { 
                    ...
                    Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.CATEGORIADOPRODUTO WHERE ID = ?", categoria_do_produto.Categoriadoproduto.class );
                    q.setParameter(1, IDSELECIONADA);   
                    
                    List<categoria_do_produto.Categoriadoproduto> list = q.getResultList();
                    
                    for (int i = 0; i < list.size(); i++){
                        Categoriadoproduto = list.get(i);
                    }   
        ...
        } catch( Exception e ){ e.printStackTrace(); JOPM JOptionPaneMod = new JOPM( 2, "excluir(), \n"
            ...
            if( btAlterar.isEnabled() ) {            
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Categoria_do_Produto_New New = new Categoria_do_Produto_New( Categoria_do_Produto_Home, Categoriadoproduto );
                        Categoria_do_Produto_Home.Home.ControleTabs.AddTabSemControleNovo( Categoria_do_Produto_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Categoria_do_Produto_New New = new Categoria_do_Produto_New( Categoria_do_Produto_Home, Categoriadoproduto );
                        Categoria_do_Produto_Home.Home.ControleTabs.AddTabSemControleNovo( Categoria_do_Produto_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
