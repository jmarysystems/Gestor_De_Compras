 ...
 * @author ana
 */
public class Tabela_Pesquisa_BD_Categoria_do_Produto extends javax.swing.JPanel {
   
    private Categoria_do_Produto_Home          Categoria_do_Produto_Home;
    private Menu_Pesquisa_Categoria_do_Produto Menu_Pesquisa;
        
    private List<categoria_do_produto.Categoriadoproduto> list;
    private ListSelectionModel               lsmPesquisa;
    private final DefaultTableModel          tmPesquisa = new DefaultTableModel( null, new String[]{ "     ID","NOME DA CATEGORIA DO PRODUTO"} );
    
    public Tabela_Pesquisa_BD_Categoria_do_Produto( Categoria_do_Produto_Home Categoria_do_Produto_Home2 ) {
    ...
    public void tabela(Menu_Pesquisa_Categoria_do_Produto Menu_Pesquisa2){ 
    ...
    public void mostrarLista( List<categoria_do_produto.Categoriadoproduto> listR ){  try {                    
            ...
            if ( listR.isEmpty() ){ //JOptionPane.showMessageDialog( null , "Nenhum dado encontrado!"); 
                ...
                for (int i = 0; i < listR.size(); i++){
                    ...
                    tmPesquisa.setValueAt( listR.get(i).getNomedacategoriadoproduto()  , i, 1);
                }
            }    
