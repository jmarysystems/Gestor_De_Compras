...
public class LoginDerby_Inicio extends Thread {  
    ...
    public void b(){  
        synchronized(this) {
            ...
            // System.getProperty("user.dir") + System.getProperty("file.separator") );
            String db_conf = System.getProperty("user.home") + System.getProperty("file.separator") + "JMarySystems"
            ...
            if( f.exists() ){
                ...
                //ControleThread_db t1 = new ControleThread_db( System.getProperty("user.home") + System.getProperty("file.separator") + "JMarySystems" );        
