...
public class LoginDerby extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("BUENO MESSEJANA GESTOR DE COMPRAS ");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 240, 240)));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login_imagens/logo_bueno.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel2.setText("GESTOR DE COMPRAS ");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login_imagens/login.png"))); // NOI18N
    ...
    public void verificarLogin(){  
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.USUARIO", Usuario.class );
            //q.setParameter(1, 1 );
            
            List<usuario.Usuario> list = q.getResultList();
                                    
            mostrarLista( list, login, senha );
            
             btConectar.setEnabled(true);
        } catch( Exception e ){ 
            e.printStackTrace();
            btConectar.setEnabled(true);
            JOPM JOptionPaneMod = new JOPM( 2, "verificarLogin(), \n"
                + e.getMessage() + "\n", "LoginDerby" ); } } }.start();               
    }
    
    protected void mostrarLista( List<usuario.Usuario> list, String login, char[] senha ){
        ...
        for (int i = 0; i < list.size(); i++){ 
            ...
            if( list.get(i).getLogin().equals( login ) ) {
                ...
                if( passwordCorreto( senha, list.get(i).getSenha() ) ) { 
                    
                    System.out.println( "Usuário encontrado e senha confere" );
                    Home_ControleThread C = new Home_ControleThread( list.get(i).getId() );
                    C.setName("Thread1");          
                    C.start(); 
            ...
            if( i == list.size() - 1 ){ JOptionPane.showMessageDialog( null, "Usuário não cadastrado!" ); }                       
        }
    }
