 ...
 * @author ana
 */
public class Tabela_Pesquisa_BD_Embalagem extends javax.swing.JPanel {
   
    private Embalagem_Home          Embalagem_Home;
    private Menu_Pesquisa_Embalagem Menu_Pesquisa;
        
    private List<embalagem.Embalagem> list;
    private ListSelectionModel               lsmPesquisa;
    private final DefaultTableModel          tmPesquisa = new DefaultTableModel( null, new String[]{ "     ID","NOME DA EMBALAGEM"} );
    
    public Tabela_Pesquisa_BD_Embalagem( Embalagem_Home Embalagem_Home2 ) {
    ...
    public void tabela(Menu_Pesquisa_Embalagem Menu_Pesquisa2){ 
    ...
    public void mostrarLista( List<embalagem.Embalagem> listR ){  try {                    
            ...
            if ( listR.isEmpty() ){ //JOptionPane.showMessageDialog( null , "Nenhum dado encontrado!"); 
                ...
                for (int i = 0; i < listR.size(); i++){
                    ...
                    tmPesquisa.setValueAt( listR.get(i).getNomedaembalagem()     , i, 1);
                }
            }    
