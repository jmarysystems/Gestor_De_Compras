 ...
 */
package embalagem_search;

import embalagem.Embalagem_Home;
 ...
 * @author AnaMariana
 */
public class Menu_Pesquisa_Embalagem extends javax.swing.JPanel {

    Embalagem_Home Embalagem_Home;
    public  int    IDSELECIONADA; 
    public Tabela_Pesquisa_BD_Embalagem Tabela_Pesquisa_BD_Embalagem;
     
    /**
     * Creates new form Cliente
     */
    public Menu_Pesquisa_Embalagem( Embalagem_Home Embalagem_Home2 ) {
        initComponents();
        
        Embalagem_Home = Embalagem_Home2;
    }
    
    public void tabela(Tabela_Pesquisa_BD_Embalagem Tabela_Pesquisa_BD_Embalagem2 ){ 
                
        try {                
            Tabela_Pesquisa_BD_Embalagem = Tabela_Pesquisa_BD_Embalagem2;                                    
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dados da Embalagem");
        ...
        rbNome.setText("Nome da Embalagem");
    ...
    private void pesquisar() {       
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.EMBALAGEM WHERE NOMEDAEMBALAGEM LIKE ?", embalagem.Embalagem.class );
            if( !tf.equals("") ){
            ...
            if(q != null) { Tabela_Pesquisa_BD_Embalagem.pesquisa(q); }
        ...
        new Thread() {   @Override public void run() { try { Thread.sleep( 1 ); 
            ...
            if( btExcluir.isEnabled() ) {
                ...
                if( IDSELECIONADA > 0 ) {
                    ...
                    Query q = JPAUtil.em().createNativeQuery( "SELECT * FROM SCHEMAJMARY.EMBALAGEM WHERE ID = ?", embalagem.Embalagem.class );
                    q.setParameter(1, IDSELECIONADA);   
                    
                    List<embalagem.Embalagem> list = q.getResultList();
                    
                    for (int i = 0; i < list.size(); i++){
                        Embalagem = list.get(i);
                    } 
            ...
            if( btAlterar.isEnabled() ) {            
                if( IDSELECIONADA > 0 ) {
                    ...
                    if( str.equals( "Visualizar") ){
                        ...
                        Embalagem_New New = new Embalagem_New( Embalagem_Home, Embalagem );
                        Embalagem_Home.Home.ControleTabs.AddTabSemControleNovo( Embalagem_Home.tabHome, "Visualizar", "/utilidades_imagens/olho.png", New );
                        ...
                        Embalagem_New New = new Embalagem_New( Embalagem_Home, Embalagem );
                        Embalagem_Home.Home.ControleTabs.AddTabSemControleNovo( Embalagem_Home.tabHome, "Alterar", "/utilidades_imagens/alterar.gif", New );
                    }
                }
                else{
                    JOPM JOptionPaneMod = new JOPM( 2, "ID SELECIONADA, "
