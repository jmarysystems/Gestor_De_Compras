 ...
 */
@Entity
@Table(name = "EMBALAGEM", catalog = "", schema = "SCHEMAJMARY")
@NamedQueries({
    @NamedQuery(name = "Embalagem.findAll", query = "SELECT e FROM Embalagem e"),
    @NamedQuery(name = "Embalagem.findById", query = "SELECT e FROM Embalagem e WHERE e.id = :id"),
    @NamedQuery(name = "Embalagem.findByNomedaembalagem", query = "SELECT e FROM Embalagem e WHERE e.nomedaembalagem = :nomedaembalagem")})
